...
namespace trkf {
  ...
  public:
    ...
    position() const
    {
      return vtx_.position();
    }
    const recob::tracking::SMatrixSym33&
    covariance() const
    {
      return vtx_.covariance();
    }
    //
    void
    setVertexId(int newID)
    {
      vtx_.setID(newID);
    }
    //
    void
    addTrack(const recob::Track& tk)
    {
      vtxtks_.push_back(tk);
    }
    void
    addTrackAndUpdateVertex(const recob::tracking::Point_t& pos,
                            const recob::tracking::SMatrixSym33& cov,
                            double chi2,
                            int ndof,
    ...
    //
    size_t
    findTrack(const recob::Track& tk) const
    {
    ...
    TrackRefVec
    tracksWithoutElement(size_t element) const
    {
