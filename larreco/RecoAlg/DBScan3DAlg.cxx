...
//----------------------------------------------------------
void
cluster::DBScan3DAlg::init(const std::vector<art::Ptr<recob::SpacePoint>>& sps,
...
node_t*
cluster::DBScan3DAlg::create_node(unsigned int index)
{
...
int
cluster::DBScan3DAlg::append_at_end(unsigned int index, epsilon_neighbours_t* en)
{
...
cluster::DBScan3DAlg::get_epsilon_neighbours(unsigned int index)
{
...
void
cluster::DBScan3DAlg::destroy_epsilon_neighbours(epsilon_neighbours_t* en)
{
  if (en) {
    node_t *t, *h = en->head;
    while (h) {
...
int
cluster::DBScan3DAlg::expand(unsigned int index, unsigned int cluster_id)
{
...
int
cluster::DBScan3DAlg::spread(unsigned int index,
...
float
cluster::DBScan3DAlg::dist(point_t* a, point_t* b) const
{
