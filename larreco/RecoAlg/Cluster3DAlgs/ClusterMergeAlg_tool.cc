...
namespace lar_cluster3d {
  ...
  private:
    ...
    TH1F*
      f1stTo2ndProjEigenHist; ///< arc length along vector between centers from first center to cylinder
    ...
    TH1F*
      f2ndTo1stProjEigenHist; ///< arc length along vector between centers from next center to cylinder
