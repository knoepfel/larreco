...
namespace genf {
  ...
  */
   ...
   */
    void
    setNextHitToFit(unsigned int i)
    {
      fNextHitToFit = i;
    }
   ...
   */
    TVector3
    getMom(const GFDetPlane& pl) const
    {
   ...
   */
    TVector3
    getPos(const GFDetPlane& pl) const
    {
   ...
   */
    void
    getPosMomCov(TVector3& pos, TVector3& mom, TMatrixT<Double_t>& cov)
    {
   ...
   */
    void
    getPosMomCov(const GFDetPlane& pl, TVector3& pos, TVector3& mom, TMatrixT<Double_t>& cov)
    {
   ...
   */
    void
    fillGeoTrack(TVirtualGeoTrack* tr) const
    {
   ...
   */
    ...
    void
    addFailedHit(unsigned int irep, unsigned int id)
    {
   ...
   */
    void
    addHitVector(std::vector<GFAbsRecoHit*> hits)
    {
      fHits = hits;
    }
   ...
   */
    void
    addTrackRep(GFAbsTrackRep* theTrackRep)
    {
   ...
   */
    void
    setCardinalRep(unsigned int r)
    {
      if ((int)r < fTrackReps->GetEntriesFast()) fCardinal_rep = r;
    }

    void
    setHitMeasuredCov(TMatrixT<Double_t> mat)
    {
      fHitMeasCov.push_back(mat);
    }
    void
    setHitUpdate(TMatrixT<Double_t> mat)
    {
      fHitUpdate.push_back(mat);
    }
    void
    setHitChi2(Double_t mat)
    {
      fHitChi2.push_back(mat);
    }
    void
    setHitState(TMatrixT<Double_t> mat)
    {
      fHitState.push_back(mat);
    }
    void
    setHitCov(TMatrixT<Double_t> mat)
    {
      fHitCov.push_back(mat);
    }
    void
    setHitCov7x7(TMatrixT<Double_t> mat)
    {
      fHitCov7x7.push_back(mat);
    }
    void
    setHitPlaneXYZ(TVector3 pl)
    {
      fHitPlaneXYZ.push_back(pl);
    }
    void
    setHitPlaneUxUyUz(TVector3 pl)
    {
      fHitPlaneUxUyUz.push_back(pl);
    }
    void
    setHitPlaneU(TVector3 pl)
    {
      fHitPlaneU.push_back(pl);
    }
    void
    setHitPlaneV(TVector3 pl)
    {
      fHitPlaneV.push_back(pl);
    }
    void
    setPDG(int pdgt)
    {
   ...
   */
    void
    setRepAtHit(unsigned int irep, int ihit)
    {
      if (irep >= getNumReps())
