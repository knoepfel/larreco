...
namespace quad {
  // -------------------------------------------------------------------------
  HeatMap::HeatMap(int _Nz, double _minz, double _maxz, int _Nx, double _minx, double _maxx)
    : minz(_minz), minx(_minx), maxz(_maxz), maxx(_maxx), Nx(_Nx), Nz(_Nz), map(Nz * Nx, 0)
  {}
